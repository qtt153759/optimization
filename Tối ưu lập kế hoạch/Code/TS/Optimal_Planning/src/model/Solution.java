...
public class Solution implements Cloneable{
     ...
     */
    protected void update(Move moveInfo){
        moveVertexToNewPart(moveInfo.posVertex,
                partitions.get(moveInfo.srcPartition),partitions.get(moveInfo.desPartition));
        obj = moveInfo.obj;
        Utils.updateInCostWeight(weightedMatrix,inCost,
                moveInfo.idxVertex,
                partitions.get(moveInfo.srcPartition),
                partitions.get(moveInfo.desPartition));
        updateViolation();
    }
     ...
     *       Double : objective value of new neighbor solution
     */
    protected Move findBestNeighbor(int[] tabu){
        int selectVerIdx=-1;
        ...
        return new Move(selectSrcPartition, selectDesPartition, selectVerPosInPart, selectVerIdx, neighBestObj);
    }
